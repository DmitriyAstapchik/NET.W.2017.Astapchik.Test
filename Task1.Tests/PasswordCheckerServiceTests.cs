...
namespace Task1.Solution.Tests
{
    ...
    {
       private static IRepository repo = Mock.Of<IRepository>();
        private static PasswordVerifier verifier = new PasswordVerifier();
        private PasswordCheckerService service = new PasswordCheckerService(repo, verifier);
        ...
        public void VerifyPasswordTest()
        {
            ...
            Assert.AreEqual(Tuple.Create(false, " is empty"), service.VerifyPassword(string.Empty));
